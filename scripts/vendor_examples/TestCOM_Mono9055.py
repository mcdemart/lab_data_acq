...
print (mo.SetClassName("Mono9055_StepperMotor.Mono9055", "C:\Program Files (x86)\Sciencetech\SciencetechCOM\SciModules\Mono9055_StepperMotor.dll"))
print (mo.SetConfigFile("C:\ProgramData\Sciencetech\SciencetechCOM\SciModules\Config\StepperMotorMono.config"))
mo.OpenConfigWindow()
